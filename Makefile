...
.PHONY : jdepend
jdepend:
	@${MAKEMAKE} --depend Makefile -- ${DEPENDFLAGS} --  ./hubub1.c ./hubub1.o


# DO NOT DELETE THIS LINE -- makemake depends on it.

./hubub1.o: ./getopt.c /usr/include/arpa/inet.h /usr/include/errno.h /usr/include/fcntl.h /usr/include/netdb.h /usr/include/netinet/in.h /usr/include/signal.h /usr/include/stdio.h /usr/include/stdlib.h /usr/include/string.h /usr/include/sys/ioctl.h /usr/include/sys/socket.h /usr/include/sys/time.h /usr/include/sys/types.h /usr/include/syslog.h /usr/include/unistd.h
